...
NCountry = {
	...
	VP_TO_SUPPLY_BASE = 5,							-- Bonus to supply from a VP, no matter the level
	...
	SUPPLY_PATH_MAX_DISTANCE = 25,					-- When supply route reach more than X nodes, the manpower+equipment delivery speed reach 100% penalty.
	...
	SPECIAL_FORCES_CAP_BASE = 0.01,					-- Max ammount of special forces battalions is total number of non-special forces battalions multiplied by this and modified by a country modifier
	SPECIAL_FORCES_CAP_MIN = 5,					-- You can have a minimum of this many special forces battalions, regardless of the number of non-special forces battalions you have, this can also be modified by a country modifier
...
NProduction = {
	...
	BASE_LICENSE_IC_COST = 20,							-- Base IC cost for lended license
...
NMilitary = {
	...
	LAND_SPEED_MODIFIER = 0.01,                    -- basic speed control
	...
	STRATEGIC_INFRA_SPEED = 20.0,                   -- Max of additional speed gained trouh=gh level for strategic redeployment per infra
	STRATEGIC_REDEPLOY_ORG_RATIO = 0.5,				-- Ratio of max org while strategic redeployment
...
NNavy = {
	...
	NAVAL_SPEED_MODIFIER = 0.1,	                    				-- basic trol
...
NOperatives = {
	...
	INTEL_NETWORK_MAX_INTELLIGENCE_AGENCY_DEFENSE_DETECTION_SCALE_FACTOR = 1.000,	-- clamp the value from the multiplication of the above factor
